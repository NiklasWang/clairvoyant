...
SDL_NACL_translate_keycode(int keycode)
{
    ...
    if (scancode == SDL_SCANCODE_UNKNOWN) {
        SDL_Log("The key you just pressed is not recognized by SDL. To help get this fixed, please report this to the SDL forums/mailing list <https://discourselibsdl.org/> NACL KeyCode %d", keycode);
    }
    return scancode;
}
