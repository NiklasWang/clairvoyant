    ...
    */
    ...
    if (window) {
        if (args->WindowActivationState != CoreWindowActivationState::Deactivated) {
            ...
            /* TODO, WinRT: see if the Win32 bugfix from https://hglibsdl.org/SDL/rev/d278747da408 needs to be applied (on window activation) */
            ...
            // https://bugzillalibsdl.org/show_bug.cgi?id=3217, whereby a
