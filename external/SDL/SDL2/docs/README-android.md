...
run:
    ...
    ./androidbuild.sh orglibsdl.testgles ../test/testgles.c
...
"orglibsdl.app" with an identifier for your product package.
...
Here's an example of a minimal class file:
    ...
    import orglibsdl.app.SDLActivity; 
...
For example, if your crash looks like this:
    ...
    I/DEBUG   (   31):          #02  pc 000014bc  /data/data/orglibsdl.app/lib/libmain.so
    I/DEBUG   (   31):          #03  pc 00001506  /data/data/orglibsdl.app/lib/libmain.so
...
application with it, changing orglibsdl.app to your package identifier:

    --- start_valgrind_app -------------------
    #!/system/bin/sh
    export TMPDIR=/data/data/orglibsdl.app
...
and tell Android to use the script to launch your application:
    ...
    adb shell setprop wrap.orglibsdl.app "logwrapper /data/local/start_valgrind_app"
...
When you're done instrumenting with valgrind, you can disable the wrapper:
    ...
    adb shell setprop wrap.orglibsdl.app ""
