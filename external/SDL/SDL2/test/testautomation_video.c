 ...
 *
* @sa http://wikilibsdl.org/moin.fcg/SDL_GetWindowBrightness
 */
int
 ...
 *
 * @sa http://wikilibsdl.org/moin.fcg/SDL_GetWindowDisplayMode
 */
int
 ...
 *
 * @sa http://wikilibsdl.org/moin.fcg/SDL_GetWindowGammaRamp
 */
int
 ...
 *
 * @sa http://wikilibsdl.org/moin.fcg/SDL_GetWindowGrab
 * @sa http://wikilibsdl.org/moin.fcg/SDL_SetWindowGrab
 */
int
 ...
 *
 * @sa http://wikilibsdl.org/moin.fcg/SDL_GetWindowID
 * @sa http://wikilibsdl.org/moin.fcg/SDL_SetWindowFromID
 */
int
 ...
 *
 * @sa http://wikilibsdl.org/moin.fcg/SDL_GetWindowPixelFormat
 */
int
 ...
 *
 * @sa http://wikilibsdl.org/moin.fcg/SDL_GetWindowPosition
 * @sa http://wikilibsdl.org/moin.fcg/SDL_SetWindowPosition
 */
int
 ...
 *
 * @sa http://wikilibsdl.org/moin.fcg/SDL_GetWindowSize
 * @sa http://wikilibsdl.org/moin.fcg/SDL_SetWindowSize
 */
int
 ...
 *
 * @sa http://wikilibsdl.org/moin.fcg/SDL_SetWindowData
 * @sa http://wikilibsdl.org/moin.fcg/SDL_GetWindowData
 */
int
