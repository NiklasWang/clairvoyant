 ...
 *
 * @sa http://wikilibsdl.org/moin.fcg/SDL_AllocFormat
 * @sa http://wikilibsdl.org/moin.fcg/SDL_FreeFormat
 */
int
 ...
 *
 * @sa http://wikilibsdl.org/moin.fcg/SDL_GetPixelFormatName
 */
int
 ...
 *
 * @sa http://wikilibsdl.org/moin.fcg/SDL_AllocPalette
 * @sa http://wikilibsdl.org/moin.fcg/SDL_FreePalette
 */
int
 ...
 *
 * @sa http://wikilibsdl.org/moin.fcg/SDL_CalculateGammaRamp
 */
int
