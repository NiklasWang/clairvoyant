 ...
 *
 * @sa http://wikilibsdl.org/moin.cgi/SDL_PumpEvents
 * @sa http://wikilibsdl.org/moin.cgi/SDL_PollEvent
 */
int
 ...
 *
 * @sa http://wikilibsdl.org/moin.cgi/SDL_AddEventWatch
 * @sa http://wikilibsdl.org/moin.cgi/SDL_DelEventWatch
 *
 */
int
